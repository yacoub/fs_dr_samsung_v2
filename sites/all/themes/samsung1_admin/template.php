 ...
 */
function samsung1_admin_preprocess_maintenance_page(&$vars) {
  // While markup for normal pages is split into page.tpl.php and html.tpl.php,
  // the markup for the maintenance page is all in the single
  // maintenance-page.tpl.php template. So, to have what's done in
  // samsung1_admin_preprocess_html() also happen on the maintenance page, it has to be
  // called here.
  samsung1_admin_preprocess_html($vars);
}

/**
 * Override or insert variables into the html template.
 */
function samsung1_admin_preprocess_html(&$vars) {
 ...
 */
function samsung1_admin_preprocess_page(&$vars) {
 ...
 */
function samsung1_admin_node_add_list($variables) {
 ...
 */
function samsung1_admin_admin_block_content($variables) {
  $content = $variables['content'];
  $output = '';
  if (!empty($content)) {
 ...
 */
function samsung1_admin_tablesort_indicator($variables) {
 ...
 */
function samsung1_admin_css_alter(&$css) {
